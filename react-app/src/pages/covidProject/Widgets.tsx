...
function Widgets(){
    ...
    const vaccineButtons = [
        <button key="add-vaccine" className="btn btn-primary add-vaccine-btn">
            <FontAwesomeIcon icon={faPlus} /> Vaccine
        </button>,
        <button key="add-dose" className="btn add-dose-dtn" style={{background: "orange", color: "#fff"}}>
            <FontAwesomeIcon icon={faPlus} /> Dose
        </button>
    ];

    let patientButton = <button className="btn btn-primary add-patient-btn"> 
